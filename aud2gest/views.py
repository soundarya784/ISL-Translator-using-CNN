...
def ajax(request):
	if request.user.is_authenticated:
		...
		print(type(file_obj))
		with default_storage.open("C:\\project\\test\\signlanguage\\Indian-Sign-Language-Gesture-Recognition-master\\media\\aud2gest\\audioFiles\\"+filename+".bin", 'wb+') as destination:
			destination.write(file_obj)
			src = "C:\\project\\test\\signlanguage\\Indian-Sign-Language-Gesture-Recognition-master\\media\\aud2gest\\audioFiles\\"+filename+".bin"
			print("hi" +src)
			dst = "C:\\project\\test\\signlanguage\\Indian-Sign-Language-Gesture-Recognition-master\\media\\aud2gest\\audioFiles\\"+filename+".wav"
